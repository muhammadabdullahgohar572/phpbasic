...
<body
    style="font-family: Arial, sans-serif; background-color: #f4f4f4; margin-left: 0%;  justify-content: center; align-items: center; height: 100vh; margin: 0;">
    <div style="width: 100%; padding-left: 25%;">
        <form id="login-form" style="width: 50%;">
