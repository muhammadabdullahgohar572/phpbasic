...
<body
    ...
    <div style="background: white; padding: 20px; border-radius: 10px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
        ...
        <form action="setpic.php" method="post" enctype="multipart/form-data">
            ...
            <div style="margin-bottom: 15px;">
                <label for="file" style="display: block; margin-bottom: 5px;">Password</label>
                <input type="file" id="file" name="file" style="width: 100%; padding: 8px; box-sizing: border-box;">
            </div>
            <button type="submit"
